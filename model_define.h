...
const REAL A_CELL_DENSITY_PER_UB[NUM_CELL_TYPES] = { 0.5 };
const REAL A_CELL_D_MAX[NUM_CELL_TYPES] = { IF_GRID_SPACING };
const REAL A_CELL_CHEMOATTRACTANT_SECRETION_RATE[NUM_CELL_TYPES] = { 0.1 };
const REAL A_CELL_CHEMOTAXIS_FORCE_STRENGTH[NUM_CELL_TYPES] = { 0.5 };
